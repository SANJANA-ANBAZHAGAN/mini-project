    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">ONLINE DELI</a>
        </div>
...
<h2 class="text-center"> Thank you for Ordering at ONLINE DELI! The ordering process is now complete.</h2>

<?php 
  $num1 = mt_rand(100000,999999); 
  $num2 = mt_rand(100000,999999); 
  $num3 = mt_rand(100000,999999);
